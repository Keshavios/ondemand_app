...
#define AUTHTOKEN                [[NSUserDefaults standardUserDefaults]objectForKey:@"AUTHTOKEN"]
...
//>>    APIs
#define appURL                  @"http://52.36.147.86/api/"
//#define appURL                  @"http://34.208.208.104/api2/"
#define appNAME                 @"Omorni"
#define GOOGLEAPIKEY            @"AIzaSyAjmQCXap3ojWcBk4N7pxwz1hHbJHSH1LA"
...
#define GETPACKAGENAME(packageName) [Util getPackageName:packageName]
